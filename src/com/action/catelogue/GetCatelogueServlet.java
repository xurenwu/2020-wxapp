...
public class GetCatelogueServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if(catelogue != null) {
			out.print(new Gson().toJson(new BaseDataPojo<Catelogue> ("获取目录成功", true, catelogue)));
		}else {
			out.print(new Gson().toJson(new BaseDataPojo<Catelogue> ("获取目录失败", false, null)));
		}
	}

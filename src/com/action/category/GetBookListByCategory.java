...
public class GetBookListByCategory extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		List<BookInfo> booklist = CategoryService.getBookInfoByCategory(category, 10);
		if(booklist != null) {
